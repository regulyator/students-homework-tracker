...
public class HomeWorkController {
    ...
    public ResponseEntity<Collection<HomeWorkDto>> getAllActiveHomeWorksByGroupIds(@RequestParam List<String> groupIds) {
        return ResponseEntity.ok(homeworkService.getActiveHomeWorkByGroupIds(groupIds));
    }
